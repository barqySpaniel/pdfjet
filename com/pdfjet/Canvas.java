...
final public class Canvas {
     ...
     *                     exception occurred
     */
    public Canvas(PDF pdf, float[] pageSize) throws Exception {
     ...
     */
    public Canvas(PDF pdf, float[] pageSize, boolean addPageToPDF) throws Exception {
        this.pdf = pdf;
    ...
    public Canvas(PDF pdf, PDFobj pageObj) {
        this.pdf = pdf;
