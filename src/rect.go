...
func (rect *Rect) DrawOn(page *Page) []float32 {
	...
	if rect.r == 0.0 {
		...
		points := make([]*Point, 0)
		points = append(points, NewPathPoint((rect.x+rect.r), rect.y, ""))
		points = append(points, NewPathPoint((rect.x+rect.w)-rect.r, rect.y, ""))
		points = append(points, NewPathPoint((rect.x+rect.w-rect.r)+rect.r*k, rect.y, "c"))
		points = append(points, NewPathPoint((rect.x+rect.w), (rect.y+rect.r)-rect.r*k, "c"))
		points = append(points, NewPathPoint((rect.x+rect.w), (rect.y+rect.r), ""))
		points = append(points, NewPathPoint((rect.x+rect.w), (rect.y+rect.h)-rect.r, ""))
		points = append(points, NewPathPoint((rect.x+rect.w), ((rect.y+rect.h)-rect.r)+rect.r*k, "c"))
		points = append(points, NewPathPoint(((rect.x+rect.w)-rect.r)+rect.r*k, (rect.y+rect.h), "c"))
		points = append(points, NewPathPoint((rect.x+rect.w)-rect.r, (rect.y+rect.h), ""))
		points = append(points, NewPathPoint((rect.x+rect.r), (rect.y+rect.h), ""))
		points = append(points, NewPathPoint((rect.x+rect.r)-rect.r*k, (rect.y+rect.h), "c"))
		points = append(points, NewPathPoint(rect.x, ((rect.y+rect.h)-rect.r)+rect.r*k, "c"))
		points = append(points, NewPathPoint(rect.x, (rect.y+rect.h)-rect.r, ""))
		points = append(points, NewPathPoint(rect.x, (rect.y+rect.r), ""))
		points = append(points, NewPathPoint(rect.x, (rect.y+rect.r)-rect.r*k, "c"))
		points = append(points, NewPathPoint((rect.x+rect.r)-rect.r*k, rect.y, "c"))
		points = append(points, NewPathPoint((rect.x+rect.r), rect.y, ""))
