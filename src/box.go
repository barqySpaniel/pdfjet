...
func (box *Box) DrawOn(page *Page) []float32 {
	...
	if box.r == 0.0 {
		...
		points := make([]*Point, 0)
		points = append(points, NewPathPoint(box.x+box.r, box.y, ""))
		points = append(points, NewPathPoint((box.x+box.w)-box.r, box.y, ""))
		points = append(points, NewPathPoint(((box.x+box.w)-box.r)+box.r*k, box.y, "c"))
		points = append(points, NewPathPoint((box.x+box.w), (box.y+box.r)-box.r*k, "c"))
		points = append(points, NewPathPoint((box.x+box.w), (box.y+box.r), ""))
		points = append(points, NewPathPoint((box.x+box.w), (box.y+box.h)-box.r, ""))
		points = append(points, NewPathPoint((box.x+box.w), ((box.y+box.h)-box.r)+box.r*k, "c"))
		points = append(points, NewPathPoint(((box.x+box.w)-box.r)+box.r*k, (box.y+box.h), "c"))
		points = append(points, NewPathPoint(((box.x+box.w)-box.r), (box.y+box.h), ""))
		points = append(points, NewPathPoint((box.x+box.r), (box.y+box.h), ""))
		points = append(points, NewPathPoint(((box.x+box.r)-box.r*k), (box.y+box.h), "c"))
		points = append(points, NewPathPoint(box.x, ((box.y+box.h)-box.r)+box.r*k, "c"))
		points = append(points, NewPathPoint(box.x, (box.y+box.h)-box.r, ""))
		points = append(points, NewPathPoint(box.x, (box.y+box.r), ""))
		points = append(points, NewPathPoint(box.x, (box.y+box.r)-box.r*k, "c"))
		points = append(points, NewPathPoint((box.x+box.r)-box.r*k, box.y, "c"))
		points = append(points, NewPathPoint((box.x+box.r), box.y, ""))
