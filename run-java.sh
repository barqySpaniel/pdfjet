...
javac -O -encoding utf-8 -Xlint com/pdfjet/*.java com/pdfjet/pdf417/*.java com/pdfjet/qrcode/*.java com/pdfjet/corefonts/*.java com/pdfjet/fonts/*.java com/pdfjet/encryption/*.java -d out/production
