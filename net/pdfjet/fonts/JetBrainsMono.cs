namespace PDFjet.NET.Fonts {
    public static class JetBrainsMono {
        ...
        public const string Light            = "fonts/JetBrainsMono/JetBrainsMono-Light.ttf.stream";
        public const string LightItalic      = "fonts/JetBrainsMono/JetBrainsMono-LightItalic.ttf.stream";
        public const string Medium           = "fonts/JetBrainsMono/JetBrainsMono-Medium.ttf.stream";
        public const string MediumItalic     = "fonts/JetBrainsMono/JetBrainsMono-MediumItalic.ttf.stream";
        public const string Regular          = "fonts/JetBrainsMono/JetBrainsMono-Regular.ttf.stream";
